...
{
    public ArmadilloWatcher(IBindTarget bindTarget)
    {
        super(bindTarget, EntityType.ARMADILLO);
    }
            ...
            switch (animId)
            {
                ...
                case AnimationNames.PANIC_IDLE, AnimationNames.RESET ->
                {
                    ...
                    if (animId.equals(AnimationNames.PANIC_IDLE))
                        world.playSound(location, Sound.ENTITY_ARMADILLO_UNROLL_FINISH, 1, 1);
                }
            }
        }
    }
