...
{
    public CreakingWatcher(IBindTarget bindTarget)
    {
        super(bindTarget, EntityType.CREAKING);
    }
        ...
        if (entry.equals(CustomEntries.ANIMATION))
        {
            ...
            switch (id)
            {
                case AnimationNames.MAKE_ACTIVE ->
                {
                    ...
                    world.playSound(location, Sound.ENTITY_CREAKING_ACTIVATE, SoundCategory.HOSTILE, 1, 1);
                }

                case AnimationNames.MAKE_INACTIVE ->
                {
                    this.writePersistent(ValueIndex.CREAKING.IS_ACTIVE, false);
                    world.playSound(location, Sound.ENTITY_CREAKING_FREEZE, SoundCategory.HOSTILE, 1, 1);
                }
            }
        }
    }
