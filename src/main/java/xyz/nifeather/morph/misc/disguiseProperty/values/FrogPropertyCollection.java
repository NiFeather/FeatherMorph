...
public class FrogPropertyCollection extends BaseLivingEntityPropertyCollection<Frog>
{
    ...
    @Override
    public void setupPropertiesFromEntity(DisguiseMeta meta, PropertyHandler propertyHandler, @NotNull Frog frog)
    {
