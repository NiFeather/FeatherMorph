...
public class PigPropertyCollection extends BaseLivingEntityPropertyCollection<Pig>
{
    ...
    @Override
    public void setupPropertiesFromEntity(DisguiseMeta meta, PropertyHandler propertyHandler, @NotNull Pig targetEntity)
    {
