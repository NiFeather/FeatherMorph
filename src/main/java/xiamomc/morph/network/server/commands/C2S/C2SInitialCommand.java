...
import xiamomc.morph.network.server.commands.S2C.S2CSetToggleSelfCommand;

import java.util.Map;

public class C2SInitialCommand extends MorphC2SCommand
{
    ...
    public void onCommand(Player player, String str)
    {
        ...
        clientHandler.waitUntilReady(player, () ->
        {
            ...
            clientHandler.sendCommand(player, new S2CSetToggleSelfCommand(config.showDisguiseToSelf));
