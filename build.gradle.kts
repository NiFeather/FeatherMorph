...
dependencies {
    compileOnly("dev.folia:folia-api:${project.property("minecraft_version")}")
...
// Disable until plugin-yml supports Folia: https://github.com/Minecrell/plugin-yml/pull/31/files
